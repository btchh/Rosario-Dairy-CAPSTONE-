    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deactivation_reason', models.CharField(choices=[('none', 'N/A'), ('leave', 'On Leave'), ('suspended', 'Suspended'), ('resigned', 'Resigned'), ('terminated', 'Terminated')], default='none', max_length=20)),
